<template>
  <div class="page-content page--programs__purchase">
    <h2>
      30-year Fixed
    </h2>
    <p>
      Choose the 30-year fixed if you plan on staying in your home for longer than 10 years. Interest rates are still at historical lows, locking into a good fixed-rate mortgage could mean security against rising rates.
    </p>
    <p>
      <nuxt-link to="/search" class="link-decorated">
        Apply Now
      </nuxt-link><br>
      <nuxt-link to="/connect" class="link-decorated">
        Connect with Loan Consultant
      </nuxt-link>
    </p>
    <h2>
      15-year Fixed
    ...
    <p>
      For example: With a $300,000 loan at a 6% interest rate, you will pay about $2,531 with a 15-year fixed as opposed to $1,798 with a 30-year fixed.
    </p>
    <p>
      <nuxt-link to="/search" class="link-decorated">
        Apply Now
    ...
    <div class="boxes">
      <div class="box">
        ...
        <div class="box__links">
          <ul>
            <li>
              <nuxt-link to="/search" class="link-text">
                Apply Now
              </nuxt-link>
            </li>
            <li>
              <nuxt-link to="/connect" class="link-text">
                Connect with Loan Consultant
              </nuxt-link>
            </li>
          </ul>
      ...
      <div class="box">
        ...
        <p>
          Fixed rate loan for 10 years, then becomes an adjustable rate mortgage.
        </p>
      </div>
    </div>
    <h2>
    ...
    <div class="boxes">
      ...
      <div class="box">
        ...
        <p>
          Interest only fixed rate loan for 10 years, then becomes a fully amortized adjustable rate mortgage.
        </p>
      </div>
    </div>
  </div>
  ...
  head () {
    return {
      ...
      meta: [
        ...
        { hid: 'description', name: 'description', content: 'Loan programs: Refinance' }
      ]
    }
  }
}
