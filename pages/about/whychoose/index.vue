<template>
  <div class="page-content page--whychoose">
    <p>
    ...
    <p>
      The One Fee Guarantee package includes the following costs, and the total you pay is <strong>guaranteed</strong> not to change at closing.
    </p>
    <ul>
      <li>
        Origination Fee
  ...
  head () {
    return {
      ...
      meta: [
        ...
        { hid: 'description', name: 'description', content: 'Why choose RateRabbit' }
      ]
    }
  }
}
