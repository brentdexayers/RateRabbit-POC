<template>
  <div class="page-content page--basics">
    <p>
  ...
  head () {
    return {
      ...
      meta: [
        ...
        { hid: 'description', name: 'description', content: 'Home-Buying Basics: Things to Consider When Choosing an Online Lender' }
      ]
    }
  }
}
