<template>
  <div class="page-content page--loanprocess--purchase">
    ...
    <ul>
      <li>
        Think about how long you plan to keep the loan. If you plan to sell the house in just a few years, you may want to consider an adjustable or balloon loan. On the other hand, if you plan to keep the house for a longer time, a fixed loan might be better for you.
      </li>
      <li>
      ...
      <li>
        Remember that rates can be locked in for varying periods: typically 30 days, sometimes 45 days, and rarely, 60 days, based on close of escrow dates. A longer rate lock-in period usually costs a little more in fees or has a slightly higher rate.
      </li>
      <li>
    ...
    <p>
      In step 2, one of our team members will call you to help make this process as easy and painless as possible. Be prepared to give us this information: social security number(s) of owner(s) to be listed on title; birthdate(s); email contact info; property address of property to be purchased; current employer, position, salary/bonuses; total of liquid assets from checking, savings, money market accounts, stocks and bonds; total retirement account value; current rent paid.
    </p>
    <p>
    ...
    <p>
      In step 3 – almost finished – we will ask additional information about your residence history if you have lived in your current residence for less than 2 years. We will ask for the breakdown detail of your account numbers for checking, savings and other accounts, plus any other information that is incomplete.
    </p>
    <ul>
      <li>
      ...
      <li>
        your 2-year residence history, if current is less than two years
      </li>
      <li>
        your 2-year employment history, if current is less than two years info on any real estate owned (address, value, existing mortgages, liens, monthly payments, taxes and insurance)
      </li>
      <li>
    ...
    <ul>
      ...
      <li>
        Bring a cashier’s check for your down payment and closing costs if required. In most cases a wire transfer from your bank account can be sent directly to the escrow company as well. Personal checks are normally not accepted.
      </li>
      <li>
  ...
  head () {
    return {
      ...
      meta: [
        ...
        { hid: 'description', name: 'description', content: 'Loan Process for New Purchases' }
      ]
    }
  }
}
