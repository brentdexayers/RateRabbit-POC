<template>
  <div class="page-content page--loanprocess--refinances">
    <ol>
      <li>
        <a href="#anchor1">Gather your documents</a>
      </li>
      <li>
        <a href="#anchor2">Get an evaluation</a>
      </li>
      <li>
    ...
    <p>
      There are many different loan programs to choose from: fixed, adjustable, interest-only, negative amortization and others. Look over the
      <nuxt-link to="/programs">
        Loan Programs
      </nuxt-link>
      section and find the one that you think best suits your needs. Calculator for Points vs. rate.
    </p>
    <p>
